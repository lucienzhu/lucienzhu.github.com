...
\begin{document}
\makeheading{\large{Xiaolong ~ZHU}}
...
%
Computer Vision, including \emph{Motion Capture}, \emph{Gesture Recognition};
...
\begin{bibsection}
    \item Zhihu Chen, Kwan-Yee K. Wong, Yasuyuki Matsushita, \textbf{Xiaolong Zhu}, Miaomiao Liu. Self-Calibrating Depth from Refraction. \emph{IEEE International Conference on Computer Vision (ICCV)}, 2011.
...
$\bullet$ Programming in: \texttt{C/C++}, \texttt{Matlab}, \texttt{Python}, \texttt{JavaScript}

$\bullet$ Basic Experience in: \texttt{jQuery/HTML/CSS}, \texttt{Processing}, \texttt{Java}, \texttt{UNIX Shell scripting}
