...
{\bf 边缘计算}，包括摄像头生态，芯片硬件行业研究，并行计算，异构计算；\\
{\bf 计算机视觉}，包括图像标签，物体检测，语义分割，关键点定位；\\
...
\begin{rSection}{工作经历}
  ...
  %------------------------------------------------
  \begin{rSubsection}{腾讯公司技术工程事业群AI平台部}{2016.08 至今}{高级研究员，TL}{深圳}
    \item 带领团队研发移动端 AI 实时计算视觉能力库；
    \item 作为 LF DL TAC 委员，推动腾讯开源项目向社区的捐献；
