...
%
\textbf{Computer Vision}, including \emph{Object Detection}, \emph{Gesture Recognition};

\textbf{Machine Learning}, including \emph{Random Forest}, \emph{SVM}, \emph{Restricted Boltzmann Machine}.

\textbf{Multimedia}, including \emph{Image Retrieval}, \emph{Human-Computer Interaction};
...
\item[] Ph.D. Candidate,
        ...
        \item Area of Study: Hand Detection and Posture Recognition
        \item Adviser:
...
\item[] B.S.,
        \href{http://eecs.pku.edu.cn/}
             {\emph{Machine Intelligence}} \hfill Sept 2006 - June 2010
        \begin{innerlist}
...
$\bullet$ Third Prize, RoboCup Rescue, Hunan China, 2010;
...
\item[] 
        \begin{innerlist}
        \item {Computer Vision}, \textit{Tutor} \hfill Spring 14
        \item {Computer Programming and Applications}, \textit{Teaching Assistant} \hfill Autumn 13
        \item {Topic in Computer Science: Visual Analysis}, \textit{Teaching Assistant} \hfill Autumn 13
        \item {Computer Vision}, \textit{Tutor} \hfill Autumn 12
        \item {Computer Programming and Applications}, \textit{Teaching Assistant} \hfill Autumn 11
        \item {Computer Programming and Applications}, \textit{Tutor} \hfill Autumn 10
        \end{innerlist}
\end{outerlist}
