...
\textbf{Machine Learning}, including \emph{Random Forest}, \emph{Restricted Boltzmann Machine}, \emph{SVM}.
...
\item[] 
        \begin{innerlist}
        \item \href{http://i.cs.hku.hk/~engg1111c}
                            {Computer Programming and Applications}, \textit{Teaching Assistant} \hfill Autumn 13
        \item \href{http://i.cs.hku.hk/~com7801}
                            {Topic in Computer Science: Visual Analysis}, \textit{Teaching Assistant} \hfill Autumn 13
        \item \href{http://i.cs.hku.hk/~csis0317} 
                            {Computer Vision}, \textit{Tutor} \hfill Autumn 12
        \item \href{http://i.cs.hku.hk/~eng1002b}
                            {Computer Programming and Applications}, \textit{Teaching Assistant} \hfill Autumn 11
        \item \href{http://i.cs.hku.hk/~eng1002b}
                            {Computer Programming and Applications}, \textit{Tutor} \hfill Autumn 10
        \end{innerlist}
\end{outerlist}
