...
%
\textbf{Computer Vision}, including \emph{Image Classification and Localization}, \emph{Semantic Labelling}, \emph{Human Pose Estimation}, \emph{Gesture Recognition};
...
\begin{outerlist}
  ...
  \item[] \textit{Senior R\&D Engineer}%
	\hfill \textbf{Aug 2016 - Present}
	\begin{innerlist}
		\item Developed an algorithm for real-time video style transfer;
		\item Deployed style transfer filters for images and live videos to QQ App;
