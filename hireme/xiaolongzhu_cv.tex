...
\href{http://www.cs.hku.hk/}%
     ...
     & \textit{MSN:} \texttt{lucienzhu@hotmail.com} \\
...
%
Computer Vision, including \emph{Gesture Recognition}, \emph{Object Recognition};

Machine Learning, including \emph{Supervised Learning}, \emph{Online Learning}.
...
\item[] Ph.D. Candidate,
        ...
        \item Adviser:
              \href{http://i.cs.hku.hk/~kykwong/}
                   {Dr. Kenneth K. Y. Wong}
        \item Area of Study: Computer Vision, especially machine learning for \emph{gesture recognition}
        \end{innerlist}
\end{outerlist}
...
\begin{bibsection}
    ...
    \item[1.] \textbf{Xiaolong Zhu}, Kwan-Yee K. Wong. Single-Frame Hand Gesture Recognition Using Color and Depth Kernel Desciptors. \emph{IEEE International Conference on Pattern Recognition (ICPR)}, 2012.

    \item[2.] Zhihu Chen, Kwan-Yee K. Wong, Yasuyuki Matsushita, \textbf{Xiaolong Zhu}, Miaomiao Liu. Self-Calibrating Depth from Refraction. \emph{IEEE International Conference on Computer Vision (ICCV)}, 2011.

    \item[3.] \textbf{Xiaolong Zhu}, Huijing Zhao, Yiming Liu, Yipu Zhao, Hongbin Zha. Segmentation and Classification of Range Image from an Intelligent Vehicle in Urban Environment. \emph{IEEE/RSJ International Conference on Intelligent Robots and Systems (IROS)}, 2010.
    %doi:10.1109/IROS.2010.5652703

    \item[4.] Huijing Zhao, Yiming Liu,\textbf{ Xiaolong Zhu}, Yipu Zhao, Hongbin Zha. Scene Understanding in a Large Dynamic Environment through a Laser-based Sensing. \emph{IEEE International Conference on Robotics and Automation (ICRA)}, 2010.
...
\item Designed a prototype of Touch-based Image Retrieval and demonstrated to CTO.
\end{innerlist}
\end{outerlist}
...
$\bullet$ IT Officer of \href{http://www.pgsa.hku.hk/}{Postgraduate Association (PGSA)} in \href{http://www.hku.hk/}{The University of Hong Kong}, 2011-2013
