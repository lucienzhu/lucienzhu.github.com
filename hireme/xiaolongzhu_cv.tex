...
\begin{document}
\makeheading{\huge{Xiaolong~ZHU} \large{\textit{I make AI for Games.}}}
...
\begin{outerlist}
  ...
  \begin{innerlist}
    \item Business solutions and AI innovations, \textit{e.g.}, Bots, NPCs,  Generative AI and Simulations;
    \item Platforms and algorithms design, \textit{e.g.}, RL, LLM Agents, Diffusion Models and GS/NeRF/SDF;
