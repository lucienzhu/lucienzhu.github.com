...
11F-034, Langke Bldg
     ...
     Inner Search Platform Department 
...
\textbf{Machine Learning}, including \emph{Random Forest}, \emph{SVM}, \emph{CNN}, \emph{RBM} and \emph{LSTM};
...
\begin{bibsection}
	\item[1.] \textbf{Xiaolong Zhu}, Wei Liu, Xuhui Jia and Kwan-Yee K. Wong. A Two-Stage Detector for Hand Detection in Ego-Centric Videos. \emph{Winter Conference on Applications of Computer Vision (WACV)}, 2016.
...
\begin{outerlist}
	...
	\item[] \textit{R\&D Developer}%
	\hfill \textbf{Jul 2015 - Present}
	\begin{innerlist}
