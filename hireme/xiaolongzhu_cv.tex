...
%
\textbf{Game AI}, including \emph{Finite State Machine}, \emph{Behavior Tree} and \emph{Neural Network}.
...
Shenzhen, China
\begin{outerlist}
  \item[] \textit{Research Engineer in the founding team}%
  \hfill \textbf{Mar 2019 - Present}
  \begin{innerlist}
    \item Modeling AI for commercial games;
    \item Helping exploring new ways of applying AI in gaming industry.
   \end{innerlist}
\end{outerlist}
