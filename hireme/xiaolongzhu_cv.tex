...
08F-023, Langke Bldg
     ...
     Artificial Intelligence Platform Department
...
\textbf{Game AI}, including \emph{Finite State Machine} and \emph{Behavior Tree}.
...
\begin{outerlist}
  ...
  \hfill \textbf{Aug 2016 - Present}
  \begin{innerlist}
    \item Led to deploy real-time face detection, landmarks and deformation on iOS/Android phones;
...
$\bullet$ TAC Member of LF Deep Learning Foundation, 2018;
